...
#################################################
def executeHLAELockOn(input_position, input_filepath, output_filepath):
    global time_orig, x_orig, y_orig, z_orig, fov_orig, time_new, x_new, y_new, z_new, fov_new, rx_new, ry_new, rz_new
    global cam_position, INPUT_FILEPATH, OUTPUT_FILEPATH
    time_orig = []
    x_orig = []
    y_orig = []
    z_orig = []
    ...
    cam_position = [float(x) for x in input_position.split()]
